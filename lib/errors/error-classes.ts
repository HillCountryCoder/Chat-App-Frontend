...
import { ErrorCodes, ErrorDetails, HttpStatus } from './types';

/**
 * Mirror all backend error classes to maintain consistency
 */
...
export class NetworkError extends BaseError {
  constructor(message = "Network error, please check your connection", details?: ErrorDetails) {
    super(message, HttpStatus.SERVICE_UNAVAILABLE, ErrorCodes.NETWORK_ERROR, details);
    Object.setPrototypeOf(this, NetworkError.prototype);
  }
}

export class ClientError extends BaseError {
  constructor(message = "An error occurred in the application", details?: ErrorDetails) {
    super(message, HttpStatus.INTERNAL_SERVER_ERROR, ErrorCodes.CLIENT_ERROR, details);
